var store = [{
        ...
        "excerpt":"Monteverde Se procede con la fase de reconocimiento lanzando primeramente un ping a la dirección IP 10.10.10.172. ❯ ping -c 1 10.10.10.172 PING 10.10.10.172 (10.10.10.172) 56(84) bytes of data. 64 bytes from 10.10.10.172: icmp_seq=1 ttl=127 time=137 ms --- 10.10.10.172 ping statistics --- 1 packets transmitted, 1 received, 0% packet loss,...","categories": ["Medium","Windows"],
        "tags": ["Windows","Active_Directory","Powershell","File_Misconfiguration"],
        "url": "http://localhost:4000/htb-monteverde/",
        "teaser":"http://localhost:4000/assets/images/htb-monteverde/monteverde.jpg"},{
        ...
        "excerpt":"Blunder Se procede con la fase de reconocimiento lanzando primeramente un ping a la dirección IP 10.10.10.191. ❯ ping -c 1 10.10.10.191 PING 10.10.10.191 (10.10.10.191) 56(84) bytes of data. 64 bytes from 10.10.10.191: icmp_seq=1 ttl=63 time=138 ms --- 10.10.10.191 ping statistics --- 1 packets transmitted, 1 received, 0% packet loss,...","categories": ["Easy","Linux"],
        "tags": ["Bash","Account_Misconfiguration"],
        "url": "http://localhost:4000/htb-blunder/",
        "teaser":"http://localhost:4000/assets/images/htb-blunder/blunder.jpg"},{
