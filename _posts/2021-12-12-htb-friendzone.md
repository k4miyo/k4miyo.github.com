...
excerpt: "Resolución de la máquina FriendZone en la plataforma de Hack The Box"                         
date: 2021-12-12
classes: wide
header:
  teaser: /assets/images/htb-friendzone/friendzone.jpg
...
tags:
  ...
  - Web
---
![](/assets/images/htb-friendzone/banner-friendzone.jpg)
...
Ya nos encontramos dentro de la máquina y podemos visualizar la flag (user.txt). Para trabajar más cómodos, hacemos un [Tratamiento de la tty](/tratamiento-tty). Ahora nos queda escalar privilegios, por lo que vamos a enumerar un poco el sistema.
